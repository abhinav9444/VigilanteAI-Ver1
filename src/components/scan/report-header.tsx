...
export function ReportHeader({ scan }: { scan: Scan }) {
  ...
  const handleExportPdf = async () => {
    ...
    try {
        ...
        // Fetch AI summary - now just a generic summary
        const summaryText = "This report details the findings of a simulated web vulnerability scan. The following sections provide an executive summary, a detailed breakdown of identified issues, and recommended remediation steps. All findings are generated by an AI model for demonstrative purposes.";
