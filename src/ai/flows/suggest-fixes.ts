...
const SuggestFixesOutputSchema = z.object({
  suggestedFixes: z
    .string()
    .describe(
      'A list of suggested fixes for the vulnerability, generated by the AI, including code snippets in Markdown format.'
    ),
});
...
const prompt = ai.definePrompt({
  ...
  **Crucially, where applicable, you MUST provide code snippets demonstrating the fix.** Use Markdown for all formatting, especially for code blocks (e.g., \`\`\`javascript).
